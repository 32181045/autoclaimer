...
def swap():
  ...
  while True:
    ...
    datED = {
      ...
      'username': user2,
      'phone_number': num,
      'biography': 'Whoops Moonl1ght was too fast',
      'external_url': ext,
      'chaining_enabled': 'on'}
    go2 = r.post(urED,headers=hedED,data=datED)
    if go2.status_code == 200:
      print(Fore.GREEN + '[+] Successfully Swapped' + f' @{user2}')
      input('Press Enter to exit')
      exit(0)
    elif go2.status_code == 400:
      print("Swap Has Not Been Completed")
...
def ta():
  ...
  if ("userId") in go.text:
    ...
    print('\n The security code is invalid !')
print("""________________________________█████_____█████
...
________██████____________██_______zubz_____________██
_____███████████________██_________100%___________██
____█████████████_______██_________was___________██
___███████████████______██_________not__________██
___████████████████______██________here_______██
...
On Thu, Mar 17, 2022 at 6:21 PM Joseph Mercier <josmer9321@student.ccs.k12.nc.us> wrote:
https://replit.com/@imprinc3/StaleWetFact#main.py

On Thu, Mar 17, 2022 at 6:07 PM Joseph Mercier <josmer9321@student.ccs.k12.nc.us> wrote:
#Instagram Swapper Written by Divine
import os
try:
  import requests
  import threading
